...
/*
anagram means : same no of character present in both the strings in
order/inorder manner frequency and char need to be same , while order can
different
...
bool isAnagram(string& s1, string& s2) {
  ...
  // if the count of both the string is 0 , that means having same frequency of
  // chars
