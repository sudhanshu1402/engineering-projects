...
- If user enters - then, statements for case: '-' is executed and program is terminated.
- This program works similarly for the _ and / operators. But, if the operator doesn't matches any of the four character [ +, -, _ and / ], the default statement is executed which displays error message.
